...
你会看到一个名为 Initial commit 或 pages-build-deployment 的工作流正在运行。

🟡 黄色旋转图标：表示正在部署中，请耐心等待（通常需要 1-2 分钟）。

🟢 绿色对勾图标：表示部署成功！
![](2026-02-09-20-25-44.png)
![](2026-02-09-20-25-53.png)

如果能看到一个带有 "Hugo Theme Stack" 标题和示例文章的精美页面，恭喜你，你的个人博客雏形已经搭建完成了！🎉
...
4. 找到以下两行并进行修改：
    ...
    title = "YSY的博客"
    ```
![](2026-02-09-20-31-17.png)
5. 修改完成后，点击页面底部的绿色按钮 **Commit changes** 保存。
![](2026-02-09-20-32-42.png)

### 2. 设置头像与个人简介 (params.toml)

这个文件主要控制侧边栏的展示内容。

1. 回到 `config/_default` 文件夹，这次我们要修改 `params.toml` 文件。
![](2026-02-09-20-34-02.png)
...
![](2026-02-09-20-38-07.png)![](2026-02-09-20-38-12.png)
2. 点击右上角的 **Add file** -> **Upload files** 。
![](2026-02-09-20-38-24.png)
3. 将你准备好的头像图片重命名为 `avatar.png`（注意后缀名要匹配），然后拖拽上传 。
![](2026-02-09-20-38-41.png)
...
![](2026-02-09-20-44-12.png)![](2026-02-09-20-45-46.png)
...
2. 找到并修改以下三项配置：
    ...
    hasCJKLanguage = true
    ```
![](2026-02-09-20-58-08.png)
![](2026-02-09-20-58-21.png)
...
3.  添加以下代码 [cite: 55-57]：
    ...
    ```
![](2026-02-09-20-59-39.png)
![](2026-02-09-21-00-07.png)
...
![](2026-02-09-21-00-15.png)

1. **删除多余分类**：
    * 进入 `content/categories`。
    * 删除 `example-category` 文件夹，保持分类清爽。
![](2026-02-09-21-00-43.png)
![](2026-02-09-21-00-53.png)
...
![](2026-02-09-21-04-41.png)
1. 勾选 **Discussions** 选项。
    * *提示：这一步非常关键，如果不开启，后续评论将无法写入。*
![](2026-02-09-21-04-53.png)
...
2. 点击绿色的 **Install** 按钮。
![](2026-02-09-21-05-59.png)
3. 在权限选择页面：
    * 选择 **Only select repositories**。
    * 在下拉菜单中找到并选中你用来存放博客的仓库（`你的用户名.github.io`）[cite: 72]。
4. 点击 **Install** 完成安装。
![](2026-02-09-21-06-50.png)
...
3. 找到 `[comments.giscus]` 区域，根据刚才网页生成的信息，**填入以下引号中**（保持格式一致）：
    ...
    [comments.giscus]
        ...
        emitMetadata = 0
    ```
    * *关键点：`repoID` 和 `categoryID` 是两串乱码一样的字符，必须从 Giscus 官网生成的代码中精确复制。*
![](2026-02-09-21-36-41.png)
...
这是写 Markdown 的必备插件，提供了快捷键、自动补全和格式化功能 [cite: 82]。
![](2026-02-09-21-42-14.png)
* **常用快捷键**：
    * **加粗**：`Ctrl + B` 
    * **斜体**：`Ctrl + I` 
    * **删除线**：`Alt + S` 
