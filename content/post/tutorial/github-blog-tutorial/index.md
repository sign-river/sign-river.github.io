...
![使用模板创建仓库](2026-02-09-20-15-47.png)
...
![填写仓库名称](2026-02-09-20-23-33.png)
...
![Actions 工作流](2026-02-09-20-25-44.png)

![部署成功](2026-02-09-20-25-53.png)
...
1. 在你的仓库主页，点击进入 `config/_default` 文件夹
   ...
   ![进入配置目录](2026-02-09-20-29-01.png)

2. 找到并点击 `config.toml` 文件

   ![打开配置文件](2026-02-09-20-30-12.png)

3. 点击文件右上角的 **铅笔图标**（Edit this file）进入编辑模式

   ![进入编辑模式](2026-02-09-20-30-27.png)
...
4. 找到以下两行并进行修改：
   ...
   ![修改配置](2026-02-09-20-31-17.png)

5. 修改完成后，点击页面底部的绿色按钮 **Commit changes** 保存

   ![提交更改](2026-02-09-20-32-42.png)
...
1. 回到 `config/_default` 文件夹，这次我们要修改 `params.toml` 文件
   ...
   ![打开 params.toml](2026-02-09-20-34-02.png)
...
2. 同样点击铅笔图标编辑，找到 `[sidebar]` 区域，参考下图修改：
   ...
   ![修改侧边栏配置](2026-02-09-20-34-27.png)
...
1. 回到仓库根目录，依次进入 `assets` -> `img` 文件夹
   ...
   ![进入 assets 目录](2026-02-09-20-38-07.png)

   ![进入 img 目录](2026-02-09-20-38-12.png)

2. 点击右上角的 **Add file** → **Upload files**

   ![上传文件](2026-02-09-20-38-24.png)

3. 将你准备好的头像图片重命名为 `avatar.png`（注意后缀名要匹配），然后拖拽上传

   ![上传头像](2026-02-09-20-38-41.png)
...
3. 在 **Build and deployment** 区域进行以下配置：
   ...
   ![配置 Pages 部署分支](2026-02-09-20-39-52.png)
...
![个性化后的博客效果](2026-02-09-20-41-15.png)
...
3. **全部删除**：点击右上角的 **...** → **Delete directory**，或者直接在本地操作删除
   ...
   ![查看演示文章](2026-02-09-20-44-12.png)

   ![删除目录](2026-02-09-20-45-46.png)
...
1. 在 `content/post` 目录下，点击 **Add file** → **Create new file**
   ...
   ![创建新文件](2026-02-09-20-46-01.png)

2. 在文件名输入框中填写：`my-first-post/index.md`
   - *注意：输入 `/` 会自动创建文件夹*
...
![第一篇文章发布成功](2026-02-09-20-54-46.png)
...
![默认社交链接](2026-02-09-20-57-24.png)
...
4. **删除 Twitter**：直接删除整个 Twitter 的配置块（从 `[[social]]` 到 `icon = "brand-twitter"` 的部分）
   ...
   ![修改社交链接配置](2026-02-09-20-57-47.png)
...
2. 找到并修改以下三项配置：
   ...
   ![修改语言配置 1](2026-02-09-20-58-08.png)

   ![修改语言配置 2](2026-02-09-20-58-21.png)
...
2. **编辑文件**：删除文件头部 `menu:` 及其下方缩进的内容（通常是 `main:` 和 `params:` 那几行）
   ...
   ![删除页面中的菜单配置](2026-02-09-20-58-52.png)
...
2. **清空** `[[main]]` 相关的旧配置，**复制粘贴**以下内容：
   ...
   ![重写主菜单配置](2026-02-09-20-59-17.png)
...
3. 添加以下代码：
   ...
   ![创建 custom.scss](2026-02-09-20-59-39.png)
...
现在的这个博客已经搭建完成。接下来的日子里，希望你能把更多的时间花在**记录和分享**上，让这里成为你思想的后花园，而不是一个仅仅为了展示技术的空壳。
