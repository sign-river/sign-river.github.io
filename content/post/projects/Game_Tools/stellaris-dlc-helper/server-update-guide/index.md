...
| 步骤 | 操作                                | 是否必须              |
| ---- | ----------------------------------- | --------------------- |
| 2.1  | 压缩更新的 DLC 文件放入备份文件夹   | ✅ 必须               |
| 2.2  | 打开 `Stellaris_DLC_Manager.exe`    | ✅ 必须               |
| 2.3  | 填写连接信息并点击连接              | ✅ 必须               |
| 2.4  | 上传 DLC → 扫描差异 → 上传          | ✅ 必须               |
| 2.5  | 更新游戏信息（从 Steam 获取并上传） | ✅ 必须               |
| 2.6  | 上传客户端更新文件                  | ⚪ 仅客户端有新版本时 |
