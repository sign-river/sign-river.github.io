...
> 本节仅供服务器管理员参考。如果你是普通玩家，到这里就可以了。

当游戏版本或 DLC 发生更新，需要在服务端执行相应的文件同步操作，详见以下专属指南：

> <span style="font-size: 18px; font-weight: bold;">🛠️ [群星 DLC 服务端更新操作手册](/p/stellaris-server-update-guide/)</span>
