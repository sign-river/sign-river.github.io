...
- [在 VirtualBox 中部署 SteamOS 测试虚拟机](/p/steamos-virtualbox-setup/)
  重新整理 SteamOS 恢复镜像、VirtualBox 配置和测试验证流程。

## 4. 使用 VMware 部署 SteamOS

- [在 VMware Workstation Pro 中部署 SteamOS 测试虚拟机](/p/steamos-vmware-setup/)
  使用 Steam Deck Recovery 镜像完成 SteamOS 写盘，并通过 EFI framebuffer、Xorg 和 Plasma X11 解决安装后的黑屏问题。
